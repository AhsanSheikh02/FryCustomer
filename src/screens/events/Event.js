...
export default function Event(props) {
    ...
    function render({ item, index }) {
        ...
        date = moment(item.start_date, 'MMM-DD-YYYY hh:mm A').format('MMM-DD-YYYY');
        time = moment(item.start_date, 'MMM-DD-YYYY hh:mm A').format('hh:mm A');
        event_date = date + '\n' + time;
    ...
    function callApiforEventList(value) {
        if (value == 2) { Toast.showLoading('Please wait..'); }
