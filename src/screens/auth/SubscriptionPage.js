...
export default function SubscriptionPage(props) {
  ...
  insideApp =
    route.params && route.params.insideApp ? route.params.insideApp : false;
  ...
  useEffect(() => {
    if (plans.length > 0) {
      plans.forEach((subscription, index) => {
        if (products[index] && products[index].subscriptionOfferDetails) {
          subscription.offerToken =
            products[index].subscriptionOfferDetails[0].offerToken;
        }
      });
    }
  }, [plans, products]);
      ...
      if (purchases.length > 0) {
        ...
        if (Platform.OS === 'android') {
          ...
          receipt = {
            ...
            purchaseTime: purchases[0].transactionDate,
          };
        }
        console.info('receipt', receipt);
        const data = plans.find(value => {
    ...
    <KeyboardAvoidingView
      ...
      {insideApp ? (
        <View
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={{margin: moderateScale(12), position: 'absolute', left: 0}}
      ...
      <View style={styles.CenterView}>
        ...
        <View
          style={[
            styles.cardView,
            {minHeight: 0, padding: moderateScale(5), alignItems: 'center'},
          ]}>
          <CustomText
            style={{textAlign: 'center', color: colors.secondary_color}}>
            By enabling this in-app purchase, you will be able to watch Yoga
            videos. as well as you can also see the live streams of yoga events
            after the subscription. So, just enable this feature by subscribing
            to any of the below plans and enjoy the Yoga at your comfort!
          </CustomText>
        </View>
          ...
          renderItem={({item, index}) => {
            return (
              <TouchableOpacity
                ...
                onPress={() => requestIAPSubscription(item)}>
                ...
                <View
                  ...
                  <CustomText
                    style={{color: 'white', fontSize: moderateScale(16)}}>
