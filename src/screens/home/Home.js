        ...
        if (notification.data.extraPayLoad) {
          if (notification.data.extraPayLoad.notification_type == 'order') {
            navigation.navigate('OrderDetails', {
              orderData: notification.data.extraPayLoad.order_no,
            });
          } else {
            let item = {
          ...
          if (notification.data.notification_type == 'order') {
            navigation.navigate('OrderDetails', {
              orderData: notification.data.order_no,
            });
          } else {
            let item = {
        ...
        {!searchBarVisible && (
          <View
            ...
            <Image
              ...
              source={require('../../../assets/images/FRY.jpg')}
            />
          </View>
        )}
          ...
          <View style={styles.NoReordContainer}>
            ...
            <CustomButton
              buttonStyle={{
                ...
                width: Dimensions.get('window').width / scale(1.5),
                alignSelf: 'center',
              }}
